...
def downgrade(migrate_engine):
    ...
    if hasattr(migrations.c, 'migration_type'):
        migrations.c.migration_type.drop()
    if hasattr(shadow_migrations.c, 'migration_type'):
        shadow_migrations.c.migration_type.drop()

    if hasattr(migrations.c, 'hidden'):
        migrations.c.hidden.drop()
    if hasattr(shadow_migrations.c, 'hidden'):
        shadow_migrations.c.hidden.drop()
